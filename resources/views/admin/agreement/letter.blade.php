   ...
   <div class="container">
    <div class="col-md-12 print-button">
        <div class=" d-flex justify-content-end mt-2">
            ...
            <a class="btn btn-dark ml-1" href="{{ route('printable.case.agreement', $case_number->id) }}">Print Warrant</a>
        </div>
    </div>
    <section style="margin-bottom: 4rem;">
        ...
        <div class="container-padding">
            <div class="row mb-3 header" style="margin-top: 4rem;">
                ...
                <div class="col-4 pl-0 second_col">
                    <div>
                        <img src="{{ asset('admin/images/logo.png') }}" class="d-block logo-size-2nd" alt="logo" />
                    </div>
                </div>
            ...
            <div class="row debtor-part" style="padding-left: 6px">
                <div class="col-md-7">
                    <ul>
                        <li>
                            <b>[<span style="font-weight: 700; color: #ff0000">{{ $case_number->name }}
                                    <span style="font-weight: 400; color: #ff0000"> / </span>{{ $case_number->company_name }}</span>]</b>
                        </li>
                    ...
                    <ul>
                        <li>
                            <b style="padding-right: 30px">OUR REF : </b> [<span
                                style="font-weight: 700; color: #ff0000">{{ $case_number->case_sku }}</span>]
                        </li>

                        <li>
                            <b>YOUR REF : </b>
                            <span style="padding-left: 20px; font-weight: 700">TBA</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <p style="font-weight: 600; font-size: 18px; padding-left: 6px;">
                        RE: DEBTS OWED TO [<span style="font-weight: 700; color: #ff0000">{{ $client_details->name }}</span>]
                    </p>
                </div>
            ...
            <div class="row order_list" style="padding-left: 40px; padding-right: 40px">
                <ol type="1">
                    <li>
                        Our firm represents Messrs./Mr/Ms [<span style="color: #ff0000">{{$client_details->name}}</span>]. We have
                        been retained by them to collect your account which is
                        seriously delinquent in the amounts of [<span style="color: #ff0000">{{ $case_number->total_amount_owed }}</span>], as
                        annexed hereto.
                    </li>
                    ...
                    <li>
                        ...
                        failure to timely pay is a breach of the Court Order/Contract Sum.
                    </li>

                    <li>
                        We will give you an opportunity to pay the amount due before any
                        further debt recovery arrangements are made, (which may include
                        but is not limited to, filing/enforcing the Judgement through
                        applying for bankruptcy, Writ of Seizure and Sale, Garnishee
                        orders and/or engaging News Media Correspondents to highlight this
                        matter at your registered addresses listed on file); however,
                        payment must be made in strict accordance with the terms of this
                        letter. The terms are as follows;
                    ...
                    <li>
                        If the total amount due is not paid to our office by the [<span
                            style="
                  font-weight: 700;
                  text-decoration: underline;
                  color: #ff0000;
                ">TODAY+
                            7 days</span>] <span class="time_after">at 15:00 hours</span>, our next course
                        of action will be enforced against you without further notice, and
                        you will be liable for any and all costs arising thereof.
                    </li>

                    <li>
                        This is a serious matter which requires your immediate attention.
                        As such, we’d advise you to expedite payment arrangements as soon
                        as possible.
                    </li>

                    <li>
                        For more information on debt settlement, debt financing and/or
                        loan assistance (case-to-case basis) via Securre Loans Division,
                        please visit our website at <span
                            style="color: #1f497d; cursor: pointer;">www.securre.net/dcms</span> or you may
                        contact us via WhatsApp at +65 8505 5484.
                    </li>
        ...
        <div class="row p-0">
            ...
            <div class="col-6 anothe-col-2">
                ...
                <ul class="ul-class">
                    ...
                    <li>
                        ii. Compounded Interests at [<span style="color: #ff0000;">{{$case_number->debt_interest}} %</span>] per annum from
                        <br />
                        [<span style="color: #ff0000;">{{ date('d-m-Y', strtotime($case_number->interest_start_date)) }}</span>] to [ <span
                            style="color: #ff0000;">{{ date('d-m-Y', strtotime($case_number->interest_end_date)) }}</span>], the date of this letter –
                    </li>
        ...
        <div class="col-md-11 d-flex justify-content-end align-items-center"
            ...
            <p>
                <span class="total-debt-div">TOTAL:</span> [<span class="total">{{ $case_number->total_amount_owed }}</span>]
            </p>
        </div>
