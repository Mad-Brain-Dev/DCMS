                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-select" name="case_type" aria-label="Default select example"
                                    ...
                                    <option class="text-capitalize" value="{{ App\Models\Cases::CASE_TYPE_UNPAID_BILLS }} {{ $cases->case_type == App\Models\Cases::CASE_TYPE_UNPAID_BILLS ? 'selected' : '' }}">
